...
#     $env:CLAUDE_GLM_TEST_ERROR=1; iwr -useb https://raw.githubusercontent.com/bioodev/claude-code-providers-hub/main/install.ps1 | iex; $env:CLAUDE_GLM_TEST_ERROR=$null
#
#   Enable debug mode:
#     $env:CLAUDE_GLM_DEBUG=1; iwr -useb https://raw.githubusercontent.com/bioodev/claude-code-providers-hub/main/install.ps1 | iex; $env:CLAUDE_GLM_DEBUG=$null
#
...
function Report-Error {
    ...
    if ($reportChoice -ne "y" -and $reportChoice -ne "Y") {
        ...
        Write-Host "  https://github.com/bioodev/claude-code-providers-hub/issues" -ForegroundColor Cyan
        Write-Host ""
    ...
    $issueUrl = "https://github.com/bioodev/claude-code-providers-hub/issues/new?title=$encodedTitle`&body=$encodedBody`&labels=bug,windows,installation"
    ...
    if (-not $browserOpened) {
        ...
        $shortUrl = "https://github.com/bioodev/claude-code-providers-hub/issues/new?title=$encodedTitle`&labels=bug,windows,installation"
...
if ($TestError) {
    ...
    Write-Host "   iwr -useb https://raw.githubusercontent.com/bioodev/claude-code-providers-hub/main/install.ps1 | iex" -ForegroundColor Cyan
    Write-Host ""
